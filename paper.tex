...
\begin{listing}[H]
	\begin{minted}{TypeScript}
		...
		interval(1000).pipe(
		  ...
		  map(i => i - 1),
		  tag('subtract')      // Tag Observable with "subtract"
		  take(2)
		).subscribe();
	\end{minted}
...
\begin{listing}[H]
	...
	\end{minted}
	\caption{rxjs-spy execution trace log generated from Listing~\ref{lst:rxjs-spy-tag}}
...
As of writing this paper, the projects owner stopped working actively on the open source application and is looking for a new maintainer\cite{rxviz-maintainer}.

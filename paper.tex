...
Transcripts of informal interviews and ``war stories'' collected from multiple practitioners will give insight in the challenges they face in their day-to-day jobs. We will validate their statement in an observational study and answer our first research question:
...
\begin{table}[]
	...
	rxfiddle           & Visual      & Web App                                                            & \begin{tabular}[c]{@{}l@{}}Visualization\\ Only\end{tabular}       & RxJS                \\ \midrule
	rxjs-spy           & Textual     & \begin{tabular}[c]{@{}l@{}}Browser Console\\and Code\end{tabular} & \begin{tabular}[c]{@{}l@{}}Limited (No\\ Breakpoints)\end{tabular} & RxJS                \\ \midrule
	Rx Visualizer      & Visual      & Web App                                                            & \begin{tabular}[c]{@{}l@{}}Visualization\\ Only\end{tabular}       & RxJS                \\ \bottomrule
	\end{tabular}
...
This is why we saw the need in validating earlier statements about manual code modification for debugging reasons with an observational study. Our study sought to validate following hypothesis:
...
We decided to monitor our subjects progress remotely using voice chat and screen sharing due to the COVID-19 situation at the time of our study. This allowed us to record the sessions with relative low technical effort for later evaluation.

The quantitative after-action survey provided after the main part of the study was provided within 24 hours after a subjects participation. We asked the subjects about (i) the number of years they have experience with RxJS, (ii) if they currently use RxJS on or off their jobs, (iii) in which field (like frontend, backend or others) they use RxJS and finally (iv) which tools and techniques they use to debug RxJS-based code.

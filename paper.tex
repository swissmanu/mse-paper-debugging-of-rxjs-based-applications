...
After the evaluation of all reports and interviews it is our speculation that software engineers are truly lacking debugging tools which ``understand'' RP concepts provided by RxJS. Though traditional debuggers can help up to some extent, they currently cannot answer all questions an engineer has as we saw repeatedly hence making manual modifications on source code necessary. We will validate this assumption after we took a look on previous efforts on the area of reactive debugging.

...
Informal interviews allowed us to gain first insights in how software engineers work with RP in their daily jobs. We talked to six professionals and asked them about the technologies they use, what their personal experience with RP was, what they most liked and most disliked about it.

Four of our interview partners stated to currently work or more recently have worked with RxJS in conjunction with Angular and/or ngrx\footnote{\url{https://ngrx.io/}} to develop frontend web applications. The fifth partner was the creator of rxfiddle, a visualization tool for RxJS \mintinline{TypeScript}{Observable}s and with this, proficient RxJS user. Our sixth interview partner finally was a backend engineer which used akka-streams\footnote{\url{https://akka.io/}} in Scala to model data-flows for a WebSocket\footnote{\url{https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API}}-based, reactive API layer serving a web frontend application.
